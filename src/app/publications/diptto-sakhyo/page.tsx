// src/app/publications/diptto-sakhyo/page.tsx
'use client';

import React from 'react';
import PublicationsGrid from '@/components/Publications/PublicationsGrid';
import { useDipttoSakhyoPublications } from '@/hooks/usePublications';
import { Publication } from '@/types/publications';

export default function DipttoSakhyoPublicationsPage() {
  const { publications, loading, error, downloadPublication } = useDipttoSakhyoPublications();
